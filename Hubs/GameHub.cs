...
public class PlayerInRoom
{
    ...
    public DateTime JoinedAt { get; set; } = DateTime.UtcNow; // para ordenar antigüedad
}
...
public class GameHub : Hub
{
    ...
    public async Task LeaveRoom(string roomCode)
    {
        if (_rooms.TryGetValue(roomCode, out var room))
        {
            ...
            // Transferir propiedad si el dueño se va y quedan jugadores
    ...
    {
        // Aquí van tus listas de palabras (las que ya tienes, son correctas)
        // Por brevedad, pongo un ejemplo mínimo; reemplázalo con tus listas reales.
        var palabras4 = new List<string> { "CASA", "GATO", "LUNA", "RICO", "MESA" }; // <- pon tus listas completas
        var palabras5 = new List<string> { "MUNDO", "RATON", "SILLA", "PERRO" };
        var palabras6 = new List<string> { "PROBAR", "SERVID", "CLIENT" };
